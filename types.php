            ...
            <div class="modal-body">
              <div class="card">
				<div class="card-body">
					...
					<input type="hidden" name="cols" value="probname,probid" />
					<input type="hidden" name="tname" value="xtm_problems" />
					
						<div class="form-group row">
							<label class="col-form-label col-sm-4">ID</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" id="probid" name="probid" placeholder="" />
							</div>
						</div>
						<div class="form-group row">
							<label class="col-form-label col-sm-4">Name</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" id="probname" name="probname" placeholder="" />
							</div>
						</div>
