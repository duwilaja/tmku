...
<nav class="main-header navbar navbar-expand navbar-dark navbar-info">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
	...
	<?php if($s_ACCESS!="U"){?>
		  <li class="nav-item has-treeview cust serv prob">
			...
			<ul class="nav nav-treeview">
				...
				<li class="nav-item">
					<a class="nav-link prob" href="types<?php echo $ext?>">
						<i class="nav-icon fas fa-angle-right"></i><p>Types</p>
					</a>
				</li>
				<!--li class="dropdown-divider"></li>
				<li class="nav-item">
		  ...
		  <li class="nav-item has-treeview rpt-tick rpt-sum">
			...
			<ul class="nav nav-treeview">
				...
				<li class="nav-item">
					<a class="nav-link rpt-tick" href="rtasks<?php echo $ext?>">
						<i class="nav-icon fas fa-angle-right"></i><p>Tasks</p>
					</a>
				</li>
			</ul>
          </li>
	...
	<?php }?>
		  <li class="nav-item">
            <a href="tasks<?php echo $ext?>" class="nav-link ticket">
