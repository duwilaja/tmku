				...
				<div class="card-body">
					...
					<?php if(false){//($s_ACCESS!='U'){?>
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<input type="text" name="calltime" id="calltimex" class="form-control datetimepicker" placeholder="" />
							</div>
						</div>
					<?php }?>
						<div class="form-group row">
						...
						<div class="form-group row">
							<label class="col-form-label col-sm-4">Attachment</label>
							<div class="col-sm-8">
								<input class="form-control" type="file" name="fattc">
							</div>
						</div>
					...
					<input type="hidden" name="tname" value="xtm_tickets" />
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								...
								<?php echo options($o_prior)?>
								</select>
							</div>
							<label class="col-form-label col-sm-2">Target</label>
							<div class="col-sm-4">
								<input type="text" name="target" id="target" class="form-control datepicker" placeholder="" />
							</div>
						</div>
						<div class="form-group row">
...
$tname="xtm_tickets";
$cols="ticketno,priority,target,customer,problem,service,detail,status,lastnote,assignedto,lastupdate,updatedby,calltime,createdon,solvedon,closedon,rowid";
$cseq="ticketno";
...
$(document).ready(function(){
	...
	mytblx = $('#examplex').DataTable({
		...
		ajax: {
			...
			url: 'datatable<?php echo $ext?>',
			data: function (d) {
				d.cols= '<?php echo base64_encode("updatedon,lastnote,status,updatedby,attc"); ?>',
...
function openHistory(){
	$(".history").text("Task# : "+$("#ticketno").val());
