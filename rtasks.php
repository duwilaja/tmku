...
?>
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container">
		<div class="row">
			<div class="col-md-2"><label>Status</label><select id="fs" class="form-control"><option value="">All Status</option>
...
$tname="xtm_tickets";
$cols="ticketno,calltime,customer,service,detail,status,lastnote,assignedto,priority,target,lastupdate,updatedby,createdon,solvedon,MY_TIMEDIFF(calltime,solvedon) as st,closedon,MY_TIMEDIFF(calltime,closedon) as ct";
